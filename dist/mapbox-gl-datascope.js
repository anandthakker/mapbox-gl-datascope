...
bel0.setAttribute("class", "mapboxgl-datascope")
          return bel0
        }())
...
appendChild(bel0, ["\n      ",arguments[0],"\n     "])
          return bel0
        }(formatProperties(options.properties, features[0]).map((row) => ((function () {
          function appendChild (el, childs) {
            for (var i = 0; i < childs.length; i++) {
              var node = childs[i];
              if (Array.isArray(node)) {
...
},{"./update-events.js":4,"morphdom":2}],4:[function(require,module,exports){
module.exports = [
